...
for i in range(0, 100):
    for j in range(0, 100):
        ...
        while True:
            opcode = p[position]
            if opcode == 1:
                p[p[position + 3]] = p[p[position + 2]] + p[p[position + 1]]
            elif opcode == 2:
                p[p[position + 3]] = p[p[position + 2]] * p[p[position + 1]]
            else:
                break # opcode is 99
